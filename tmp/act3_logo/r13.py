...
print(render("03_SCN_P05_XRAY_MECHANISM", 1396, "final_wide_1396", pct=50, samples=64))
print(render("03_SCN_P05_XRAY_MECHANISM", 1320, "final_dev_1320", (0.035,0.245),(0.27,0.80), samples=96))
