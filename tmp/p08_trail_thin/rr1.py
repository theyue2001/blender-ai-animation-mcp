...
OUT=r"C:/Users/mountain/AppData/Local/Temp/claude/d-----26-0825----3D---VScode/87e289ce-469b-4c17-8671-68b6cfdb67b0/scratchpad/ring1"
...
try:
    ...
    sc.frame_set(2650); sc.render.filepath=OUT+"/layout.png"
    bpy.ops.render.render(write_still=True); done.append(2650)
except Exception:
